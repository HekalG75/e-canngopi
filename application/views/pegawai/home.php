            ...
            <div class="card"> 
              ...
              <form method="post" action="pegawai/proses_absen">
               <div class="card-body">
                  ...
                  $waktuAbsenMulai = strtotime('03:51:00'); // Ganti dengan waktu mulai yang diizinkan
                  $waktuAbsenSelesai = strtotime('03:52:00'); // Ganti dengan waktu selesai yang diizinkan
